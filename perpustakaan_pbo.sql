...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 05 Jun 2024 pada 12.37
...
('A14', 'NiNo', '4560987653', 'Jl. Surya Kencana No. 21', '094560987653', 'JUR14'),
...
('1', 'Naruto Shippuden', '2008', '50', '10UJ', '10MA', 'CIA'),
...
INSERT INTO `pegawai` (`idpegawai`, `username`, `password`, `nama`) VALUES
(1, 'admin', 'admin', 'admin');
...
CREATE TABLE `peminjam` (
  ...
  `TANGGAL_PEMINJAM` date DEFAULT NULL COMMENT 'tanggal peminjaman',
  `TANGGAL_KEMBALI` date DEFAULT NULL COMMENT 'jadwal tanggal kembali buku',
  `TGL_KEMBALI_RILL` date DEFAULT NULL COMMENT 'tangal kembali nya buku sebenarnya',
...
INSERT INTO `peminjam` (`ID_PEMINJAM`, `TANGGAL_PEMINJAM`, `TANGGAL_KEMBALI`, `TGL_KEMBALI_RILL`, `DENDA`, `ID_BUKU`, `JUMLAH_PINJAM`, `ID_ANGGOTA`) VALUES
('P1', '2023-09-01', '2023-09-06', NULL, 0, '1', 2, 'A1'),
('P10', '2023-09-10', '2023-09-13', NULL, 0, '10', 1, 'A10'),
('P11', '2023-09-11', '2023-09-20', NULL, 4000, '11', 3, 'A11'),
('P12', '2023-09-12', '2023-09-15', NULL, 0, '12', 1, 'A12'),
('P13', '2023-09-13', '2023-09-16', NULL, 0, '13', 2, 'A13'),
('P14', '2023-09-14', '2023-09-17', NULL, 0, '14', 3, 'A14'),
('P15', '2023-09-15', '2023-09-29', NULL, 14000, '15', 1, 'A15'),
('P16', '2023-09-16', '2023-09-19', NULL, 0, '16', 2, 'A16'),
('P17', '2023-09-17', '2023-09-20', NULL, 0, '17', 3, 'A17'),
('P18', '2023-09-18', '2023-09-27', NULL, 4000, '18', 1, 'A18'),
('P19', '2023-09-19', '2023-09-27', NULL, 2000, '19', 2, 'A19'),
('P2', '2023-09-02', '2023-09-07', NULL, 0, '2', 1, 'A2'),
('P20', '2023-09-20', '2023-09-23', NULL, 0, '20', 3, 'A20'),
('P21', '2023-09-10', '2023-09-13', NULL, 0, '3', 4, 'A21'),
('P22', '2023-09-07', '2023-09-10', NULL, 0, '5', 2, 'A22'),
('P23', '2023-09-08', '2023-09-12', NULL, 0, '5', 2, 'A6'),
('P24', '2023-09-06', '2023-09-08', NULL, 0, '22', 2, 'A6'),
('P25', '2023-12-14', '0000-00-00', NULL, 0, '1', 2, 'A11'),
('P26', '2023-12-17', '2023-12-19', NULL, 0, '1', 5, 'A12'),
('P3', '2023-09-03', '2023-09-06', NULL, 0, '3', 3, 'A3'),
('P4', '2023-09-04', '2023-09-07', NULL, 0, '4', 2, 'A4'),
('P5', '2023-09-05', '2023-09-08', NULL, 0, '5', 1, 'A5'),
('P6', '2023-09-06', '2023-09-09', NULL, 0, '6', 3, 'A6'),
('P7', '2023-09-07', '2023-09-10', NULL, 0, '7', 1, 'A7'),
('P8', '2023-09-08', '2023-09-11', NULL, 0, '8', 2, 'A8'),
('P9', '2023-09-09', '2023-09-12', NULL, 0, '9', 2, 'A9'),
('PJ1224', '2024-05-26', '2024-05-18', NULL, NULL, '1', 2, 'A1'),
('PJ1245sf', '2024-05-26', '2024-05-24', NULL, NULL, '1', 3, 'A1');
...
--
ALTER TABLE `pegawai`
  MODIFY `idpegawai` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
COMMIT;
